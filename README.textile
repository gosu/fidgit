...
* _file_browser([:open, :save], ...)_ - A file browser to load or save a file (Block is passed the button pressed and the file path set)
...
* _toggle_button(...)_ - Button that can be toggled on/off (Block handles :changed event).
